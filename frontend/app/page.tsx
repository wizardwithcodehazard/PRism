      ...
      <section className="relative pt-28 md:pt-32 pb-20 px-6 z-10 flex flex-col items-center text-center">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            ...
            <a href="#demo" className="glass-card px-8 py-4 rounded-full text-base font-semibold text-white/90 hover:text-white transition-colors flex items-center justify-center">
              View Live Demo
            </a>
          </motion.div>
        </motion.div>
